              ...
              <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                <div className="flex-shrink-0 flex items-center px-4">
                  <img
                    ...
                    src="https://tailwindui.com/img/logos/workflow-logo-teal-300-mark-white-text.svg"
                    alt="Workflow"
                  />
                </div>
                  ...
                  {navigation.map((item) => (
                    <a
                      ...
                      className={classNames(
                        item.current
                          ? 'bg-teal-800 text-white hover:text-white'
              ...
              <nav className="mt-5 flex-1 px-2 space-y-1">
                {navigation.map((item) => (
                  <a
                    ...
                    href={item.href}
                    className={classNames(
                      item.current ? 'bg-teal-800 text-white' : 'text-white hover:bg-teal-600 hover:bg-opacity-75',
                      'group flex items-center px-2 py-2 text-sm font-medium rounded-md'
                    )}
                  >
                    <item.icon className="mr-3 flex-shrink-0 h-6 w-6 text-teal-300" aria-hidden="true" />
                    {item.name}
                  </a>
                ))}
              </nav>
              ...
              <a href="#" className="flex-shrink-0 w-full group block">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs font-medium text-teal-200 group-hover:text-white">View profile</p>
                  </div>
                </div>
              </a>
            </div>
